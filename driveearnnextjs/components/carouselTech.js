export default function CarouselTech(props) {
    return(
        <div id="carouselTech" className="carousel slide" data-bs-ride="false">
            ...
            <button className="carousel-control-prev" type="button" data-bs-target="#carouselTech" data-bs-slide="prev">
            <span className="carousel-control-prev-icon" aria-hidden="true"></span>
            <span className="visually-hidden">Previous</span>
            </button>
            <button className="carousel-control-next" type="button" data-bs-target="#carouselTech" data-bs-slide="next">
